...
1.  前往 [Releases](https://github.com/JinHanAI/echo-bookmark-sync/releases) 页面下载最新的 `.dmg` 安装包。
...
1.  **克隆项目**
    ```bash
    git clone https://github.com/JinHanAI/echo-bookmark-sync.git
...
1.  Download the latest `.dmg` from [Releases](https://github.com/JinHanAI/echo-bookmark-sync/releases).
